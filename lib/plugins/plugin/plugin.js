      ...
      .then((plugins) => {
        ...
        if (plugin) {
          ...
          if (!fs.existsSync(packageJsonFilePath)) {
            ...
            const pacakgeJsonFileContent = {
              name: 'my-serverless-service',
              dependencies: {},
            };
            fse.writeJsonSync(packageJsonFilePath, pacakgeJsonFileContent);
          }
          ...
          childProcess.execSync(`npm install --prefix ${servicePath} --save ${pluginName}`);
  ...
  uninstall() {
    return BbPromise.bind(this)
      ...
      .then(() => {
        ...
        childProcess.execSync(`npm uninstall --prefix ${servicePath} --save ${pluginName}`);
